...
public class AuthService {
    ...
    public AuthService(Context context) {
        mContext = context;
        try {
            mClient=new GlobalSwimRecords().MobileClient.withFilter(new MyServiceFilter());
    ...
    public void setUserAndSaveData(JsonObject jsonObject) {
        ...
        saveUserData(userId,token);
                /*SharedPreferences prefs =  mContext.getSharedPreferences(SHAREDPREFFILE, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString(USERIDPREF, mClient.getCurrentUser().getUserId());
        editor.putString(TOKENPREF, mClient.getCurrentUser().getAuthenticationToken());
        editor.commit();*/
                ...
                public void onResponse(ServiceFilterResponse response, Exception exception) {
                    ...
                    if (statusCode == 401) {
                        ...
                        if (mShouldRetryAuth && !mIsCustomAuthProvider) {
                            ...
                            SwimAppApplication myApp = (SwimAppApplication) mContext;
                                    ...
                                    mClient.login(mProvider, new UserAuthenticationCallback() {
                                        ...
                                        public void onCompleted(MobileServiceUser user, Exception exception,
                                            ...
                                            if (exception == null) {
                                                ...
                                                saveUserData(user.getUserId(),user.getAuthenticationToken());
