 ...
 */
public class AzureSyncService extends Service {
    ...
    public class LocalBinder extends Binder {
        AzureSyncService getService() {
            return AzureSyncService.this;
        }
    }
    ...
    public void SyncRecords()
    {
        ...
        if(UserSwims.size()!=0) {
            ...
            final tbl_swim_all temp_all = new tbl_swim_all();
            ...
            for(int i=0;i<UserSwims.size();i++) {
                ...
                if(UserSwims.get(i).AzureFlag==false&&UserSwims.get(i).analysed==true) {
                  //  UserSwims.get(i).AzureFlag=true;
            ...
            if(temp_all.all_swims.length!=0)


            new GlobalSwimRecords().MobileClient.getTable(tbl_swim_all.class).insert(temp_all, new TableOperationCallback<tbl_swim_all>() {
